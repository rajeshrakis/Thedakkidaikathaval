...
from Thedakkidaikkathaval import NO_LOAD
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 4 : 4 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("• ʜᴏᴍᴇ •", callback_data="rakis_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("• ʙᴀᴄᴋ •", callback_data="rakis_back")]]
